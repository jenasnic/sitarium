...
class TmdbUtil
{
     ...
     *
     * @param integer $level Level we want to get matching min vote count. 0 for easy level, 1 for medium or 2 for hard level.
     *
     * @return integer Mininum vote count for movies matching specified level.
     */
